...
/** Новая запись: квадрат с пером — универсальный «создать» без двойных
 *  смыслов (пузырь с плюсом читался как два символа, слипшихся в один). */
export const SquarePen = glyph(
  'square-pen',
  <>
    <path d="M12.4 4.7H6.4A1.9 1.9 0 0 0 4.5 6.6v11a1.9 1.9 0 0 0 1.9 1.9h11a1.9 1.9 0 0 0 1.9-1.9v-6" />
    <path d="M17.6 3.9a2 2 0 0 1 2.8 2.8l-7.8 7.8-3.7.9.9-3.7z" />
  </>,
);

...
export const RESEARCH_SYSTEM =
  ...
  'прочитай 2–3 лучших источника через read_page. Каждый фактический тезис помечай сноской [n] с номером ' +
  'результата поиска, на который опираешься. Раздел «Источники» НЕ пиши — интерфейс покажет его сам.';
